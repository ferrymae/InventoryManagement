                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="table.php" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>Items Delivered by Suppliers</span></a>
									
									<a href="supplier.php" aria-expanded="true"><i class="fa fa-table"></i>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Product Records</span></li>
                            </ul>
                        </div>
                    </div>
...
<form method="POST" action="additem.php">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="prroduct_description">
                 ...
                 while ($row = $result->fetch_assoc()) 
				 {
                   ...
                   <tr>
                    <th><?php echo $count ?></th>
					  ...
					  <th><?php echo $row["prroduct_description"] ?></th>
